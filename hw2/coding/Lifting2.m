...
% training
classifier1 = PerceptronClassifier.train(X, y, 2, 0.1, 0.0001);
...
% training
classifier2 = PerceptronClassifier.train(X, y, 2, 0.00001, 0.000001);
...
% training
classifier3 = PerceptronClassifier.train(X, y, 2, 0.1, 0.0001);
